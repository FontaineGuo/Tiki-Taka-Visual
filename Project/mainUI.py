...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.MainTabCtr.sizePolicy().hasHeightForWidth())
        self.MainTabCtr.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        ...
        self.team_Chart = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_7)
        self.team_Chart.setContentsMargins(0, 0, 0, 0)
        self.team_Chart.setObjectName("team_Chart")
        self.team_ChartShow = QtWidgets.QWidget(self.verticalLayoutWidget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.team_ChartShow.sizePolicy().hasHeightForWidth())
        self.team_ChartShow.setSizePolicy(sizePolicy)
        self.team_ChartShow.setObjectName("team_ChartShow")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Tiki-Taka DataVisual"))
